...
| `REPORT_HOUR` | Година відправки звітів | `7` |
...
python power_monitor_improved.py
```
...
Environment="ROUTER_1_IP=1.2.3.4"
Environment="ROUTER_2_PORT=1234"

ExecStart=/usr/bin/python3 /opt/folder-monitor/power_monitor_improved.py
Restart=always
RestartSec=10
...
🟢 Світло було: 18г 45хв 12с
└ Увімкнень: 3

🔴 Світла не було: 5г 14хв 48с
└ Вимкнень: 3

🟡 Інтернет не працював: 0с
└ Інцидентів: 0
```
...
```
/opt/folder-monitor/
├── power_monitor_improved.py    # Основний скрипт
